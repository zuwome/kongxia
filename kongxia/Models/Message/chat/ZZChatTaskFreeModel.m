...
@implementation ZZChatTaskFreeModel

+(instancetype)messageWithContent:(NSString *)content {
    ZZChatTaskFreeModel *msg = [[ZZChatTaskFreeModel alloc] init];
    if (msg) {
        msg.message = content;
    }
    return msg;
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder {
    ...
    if (self){
        ...
        self.pdg = [aDecoder decodeObjectForKey:@"pdg"];
    }
...
- (void)encodeWithCoder:(NSCoder *)aCoder {
    ...
    [aCoder encodeObject:self.pdg forKey:@"pdg"];
}
...
- (NSData *)encode {
    ...
    if (self.pdg) {
        [dataDict setObject:self.pdg forKey:@"pdg"];
    }
