...
@interface ZZPopularityRulesVC () <WKNavigationDelegate,UIScrollViewDelegate,WBSendVideoManagerObserver>
...
@implementation ZZPopularityRulesVC
...
//    [self.view addSubview:rightBtn];
    ...
    [_wkWebView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"https://www.movtrip.com/user/priority/rankkx.html"]]];
