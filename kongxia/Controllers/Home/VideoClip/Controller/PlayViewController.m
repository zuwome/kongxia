...
- (void)viewDidLoad {
    ...
    if (self.actionType == PLSActionTypeGif) {
        // 演示 gif 动图
        UIWebView *webView = [[UIWebView alloc] initWithFrame:CGRectMake(0, NAVIGATIONBAR_HEIGHT, SCREEN_WIDTH, SCREEN_HEIGHT - NAVIGATIONBAR_HEIGHT)];
...
- (void)setupToolboxUI {
    ...
    self.uploadButton.frame = CGRectMake(SCREEN_WIDTH - 80, 0, 80, 64);
...
- (void)onDurationTimer {
    ...
    NSString *info = [NSString stringWithFormat:@"videoFPS:%d, bitrate: %.2fkbs", _player.videoFPS, _player.videoBitrate];
