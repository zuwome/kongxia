...
- (void)setImageData:(UIImage *)imageData {
    ...
    NSInteger cellSize = (NSInteger)(SCREEN_WIDTH - 5)/4;
...
- (UIButton *)previewButton {
    if (!_previewButton) {
        UIButton *previewButton = [[UIButton alloc]initWithFrame:CGRectMake(SCREEN_WIDTH - 100, 6, 80, 30)];
...
- (UIView *)bottomView{
    if (!_bottomView) {
        UIView *bottomView = [[UIView alloc]initWithFrame:CGRectMake(0, SCREEN_HEIGHT - 64 - 42, SCREEN_WIDTH, 42)];
...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        ...
        self.collectionView = [[UICollectionView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT - NAVIGATIONBAR_HEIGHT - 42) collectionViewLayout:layout];
