...
@interface ZZTopicNewViewController () <UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout, XRWaterfallLayoutDelegate>
...
@implementation ZZTopicNewViewController
...
{
    NSMutableDictionary *aDict = [@{@"type":@"latest"} mutableCopy];
    if (sort_value) {
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    controller.dataIndexPath = indexPath;
    controller.hidesBottomBarWhenPushed = YES;
    controller.playType = PlayTypeTopicNew;
    controller.deleteCallBack = ^{
        [weakSelf pullRequest:nil];
    };
    controller.firstFindModel = model;
