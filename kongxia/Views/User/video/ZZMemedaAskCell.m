...
@implementation ZZMemedaAskCell
...
{
    [_headImgView setUser:model.mmd.to width:50 vWidth:12];
    _nameLabel.text = model.mmd.to.nickname;
    ...
    _priceLabel.text = [NSString stringWithFormat:@"￥%.2f",model.mmd.total_price];
