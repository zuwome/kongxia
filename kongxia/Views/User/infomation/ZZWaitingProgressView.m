...
@interface ZZWaitingProgressView ()
...
@implementation ZZWaitingProgressView
...
//    _aLayer.strokeColor = kBGColor.CGColor;//固定圆的填充色
    _aLayer.strokeColor = [UIColor clearColor].CGColor;
