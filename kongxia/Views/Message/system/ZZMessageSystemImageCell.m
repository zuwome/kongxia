...
@implementation ZZMessageSystemImageCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        [_contentLabel mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.mas_equalTo(_contentImgView.mas_bottom).offset(11.5);
...
- (void)setData:(ZZSystemMessageModel *)model {
    ...
    if (model.message.link) {
        _headImgView.image = [UIImage imageNamed:@"system_icNoticeHuodong"];
