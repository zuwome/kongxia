...
// https://blog.csdn.net/qq_33804688/article/details/120047229
...
@objc class LocationUtil: NSObject {
    // 坐标转换 标准坐标系-> 中国坐标系
    //          WGS-84 --> GCJ-02
    // wgsLocation:     标准坐标
    @objc public static func transformWGSToGCJ(wgsLocation:CLLocationCoordinate2D)->CLLocationCoordinate2D
    {
    ...
    //          GCJ-02 --> BD-09
    // location:     中国标准坐标
    @objc public static func transformGCJToBaidu(location: CLLocationCoordinate2D) -> CLLocationCoordinate2D
    {
    ...
    //          BD-09 --> GCJ-02
    // location:     百度坐标
    @objc public static func transformBaiduToGCJ(location: CLLocationCoordinate2D)-> CLLocationCoordinate2D
    {
    ...
    //          GCJ-02 --> WGS-84
    // wgsLocation:     中国坐标
    @objc public static func transformGCJToWGS(location: CLLocationCoordinate2D) -> CLLocationCoordinate2D
    {
    ...
    //WGS-84 --> BD-09
    @objc public static func transformFromWGSToBaidu(location: CLLocationCoordinate2D) -> CLLocationCoordinate2D
    {
    ...
    //BD-09 --> WGS-84
    @objc public static func transformFromBaiduToWGS(location: CLLocationCoordinate2D) -> CLLocationCoordinate2D
    {
