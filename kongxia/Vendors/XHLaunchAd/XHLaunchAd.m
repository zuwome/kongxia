...
+(void)showWithAdFrame:(CGRect)frame setAdImage:(setAdImageBlock)setAdImage showFinish:(showFinishBlock)showFinish
{
    ...
    ZZNavigationController *navCtl = [[ZZNavigationController alloc] initWithRootViewController:AdVC];
    [[UIApplication sharedApplication].delegate window].rootViewController = navCtl;
...
-(void)skipAction{
    [MobClick event:Event_click_launchad_skip];
