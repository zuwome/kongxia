...
- (void)customZoomNextTransitionAnimation:(id<UIViewControllerContextTransitioning>)transitionContext
{
    [self zoomNextAnimationWithContext:transitionContext];
}

- (void)customZoomBackTransitionAnimation:(id<UIViewControllerContextTransitioning>)transitionContext
{
    [self zoomBackWithContext:transitionContext];
}
