...
- (NJKScrollDirection)detectScrollDirectionWith:(CGFloat)currentOffsetY and:(CGFloat)previousOffsetY
{
    return currentOffsetY > previousOffsetY ? NJKScrollDirectionUp   :
           currentOffsetY < previousOffsetY ? NJKScrollDirectionDown :
                                              NJKScrollDirectionNone;
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    NJKScrollDirection currentScrollDirection = [self detectScrollDirectionWith:currentOffsetY and:_previousOffsetY];//  detectScrollDirection(currentOffsetY, _previousOffsetY);
