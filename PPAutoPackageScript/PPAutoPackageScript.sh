...
# 指定输出归档文件地址
export_archive_path="$export_path/$scheme_name$(date +%Y%m%d%H%M%S).xcarchive"
# 指定输出ipa地址
...
export LC_ALL=en_US;
echo "正在上传到fir.im...."
fir publish $export_ipa_path/$ipa_name.ipa --changelog="test library ipa" -T "633ef8caf63d1d79f05f299b02bf89b3"
echo "\n打包上传更新成功！"
